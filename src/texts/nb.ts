...
export default {
    ...
    'forside.naarErklaeres.title': 'Når må farskapet erklares?',
    'forside.naarErklaeres.content.1': 'Når barnets foreldre ikke er gift med hverandre, følger ikke farskapet direkte av loven.',
    'forside.naarErklaeres.content.2': 'Det vanlige i slike tilfeller er at farskap etableres ved at mor oppgir hvem som er far, og han erklærer farskapet. Farskap kan erklæres digitalt ved at begge foreldrene identifiserer seg elektronisk på en sikker måte og signerer en digital erklæring.',

    'forside.rettigheter.title': 'Rettigheter og plikter',
    'forside.rettigheter.content': 'Å erklære farskap for et barn gir far både rettigheter og plikter ovenfor barnet, som for eksempel:',
    ...
    'forside.hvem.content.1': 'Begge foreldrene har norsk fødsels- og personnummer',
    'forside.hvem.content.2': 'Begge foreldrene er over 18 år',
    ...
    'forside.alleredeRegistrert.title': 'Lurer du på om farskapet er allerede registert?',
    'forside.alleredeRegistrert.content': 'Har du allerede fått barn og  farskapet er allerede signert av mor og far, ber vi deg  å ta kontakt med ta kontakt med Skatteetaten (Folkeregister):      ',
