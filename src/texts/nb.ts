...
export default {
    ...
    'forside.pvk.title': 'Slik behandler NAV personopplysningene dine',
    'forside.pvk.mor.content': 'NAV innhenter følgende opplysninger fra deg fra offentlige registre før du kan påbegynne en erklæring om farskap:',
    'forside.pvk.mor.list.1': 'Sivilstand',
    'forside.pvk.mor.list.2': 'Alder',
    'forside.pvk.mor.list.3': 'Kjønn',
    'forside.pvk.mor.list.4': 'Bostedsadresse',
    'forside.pvk.mor.list.5': 'Familieforhold',
    'forside.pvk.far.content': 'Mor gir NAV opplysninger om ditt fulle navn og personnummer. I tillegg innhenter vi følgende opplysninger fra offentlige registre før kan erklære farskap:',
    'forside.pvk.far.list.1': 'Alder',
    'forside.pvk.far.list.2': 'Kjønn',
    'forside.pvk.far.list.3': 'Aktivt personnummer',
    'forside.pvk.etterSignering': 'Når begge foreldrene har signert erklæringen overføres den til Folkregisteret/Skatteetaten for registrering og arkivering.',
    'forside.pvk.personvernerklaering.title': 'Personvernerklæringen i NAV',
    'forside.pvk.personvernerklaering.content': 'Du kan lese mer om hvordan NAV behandler personopplysninger i Arbeids- og velferdsetatens personvernerklæring på <a>nav.no/personvern</a>.',
    'forside.pvk.personvernerklaering.link': 'https://www.nav.no/no/NAV+og+samfunn/Om+NAV/personvern-i-arbeids-og-velferdsetaten/personvernerkl%C3%A6ring-for-arbeids-og-velferdsetaten',
